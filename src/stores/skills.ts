...
export const useSkillsStore = defineStore('skills', ()=>{
  ...
  const Skills = [
    ...
    { name: "React", level: "60%", category: "Frontend", note: "Learning / in progress" },
    { name: "Angular", level: "60%", category: "Frontend", note: "Learning / in progress" },
    { name: "Next.js", level: "60%", category: "Frontend", note: "Learning / in progress" },
    { name: "HTML5", level: "95%", category: "Frontend" },
    { name: "CSS / SASS", level: "95%", category: "Frontend" },
    { name: "JavaScript", level: "95%", category: "Frontend" },
    { name: "TypeScript", level: "90%", category: "Frontend" },
    { name: "Bootstrap", level: "90%", category: "Frontend" },
    { name: "Tailwind CSS", level: "85%", category: "Frontend" },
    { name: "Vuetify", level: "85%", category: "Frontend" },

    { name: "Java", level: "90%", category: "Backend", note: "Strong experience" },
    ...
    { name: "AWS", level: "35%", category: "Cloud", note: "Basic knowledge" },
    { name: "Vercel", level: "80%", category: "DevOps", note: "Deployments & hosting" },

    { name: "Figma", level: "95%", category: "Design", note: "Advanced" },
